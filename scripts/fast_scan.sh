#!/bin/bash
#
# Fast Scan Script - Balanced Speed and Accuracy (10 frames)
# Purpose: Good balance between speed and RSRP accuracy
...
OUTPUT_FILE="${EXPORT_DIR}/fast_scan_${TIMESTAMP}.json"
